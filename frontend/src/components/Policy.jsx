    ...
    >
      ...
      <div className="space-y-8 text-slate-300 leading-relaxed relative z-10">
        <section>
          ...
          <p className="mb-4">
            All 1:1 consultation bookings must be paid in advance. If you need to cancel or reschedule your session, please email <a href="mailto:contact@thejenishshah.com" className="text-white underline decoration-white/30 underline-offset-2 hover:text-slate-300">contact@thejenishshah.com</a> at least 24 hours before your scheduled call time. Cancellations made within 24 hours of the call time will not be refunded.<br/><br/>
        ...
        <section>
          ...
          <p className="mb-4">
            ...
            You may request access to or deletion of your personal data at any time by emailing <a href="mailto:contact@thejenishshah.com" className="text-white underline decoration-white/30 underline-offset-2 hover:text-slate-300">contact@thejenishshah.com</a>.
          </p>
        </section>
        ...
        <section>
          ...
          <p>
            For any questions or concerns regarding these terms, please contact us at <a href="mailto:contact@thejenishshah.com" className="text-white underline decoration-white/30 underline-offset-2 hover:text-slate-300">contact@thejenishshah.com</a>.
          </p>
        </section>
      </div>
    </motion.section>
